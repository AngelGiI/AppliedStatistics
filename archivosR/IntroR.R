...
#                  ESTE SCRIPT ESTÁ BASADO EN EL LIBRO            
...
# de la sesión. Es posible después acceder a ellas u obtener su valor actual. #

x=sqrt(25)+2
x
print(x)

# R tiene disponible diversa documentación de ayuda sobre el lenguaje 
...
# muy diversos procedimientos estadísticos en la forma de 'paquetes', que son 
...
# como ejemplo. Este paquete se llama HSAUR (siglas del título del libro). 
...
# siendo uno de los más útiles el llamado 'data frame' por su flexibilidad y 
...
# función print(). Pero esto no será realmente muy útil de cara a hacernos una
...
# con valor TRUE para las observaciones sin ningún valor missing. #
...
# compañías están situadas en EEUU (US), y también que la mayoría de las compañias
...
#
# Por ejemplo, podríamos comparar los beneficios de las compañías en cada una
...
# conducirían a un resultado no informativo de la función median(). #
...
# variables numéricas se suelen conocer como 'de regresión'. En R, este tipo
...
# funciones de R que construyen modelos estadísticos, como veremos en temas
# posteriores.
#
...
# En tanto las variables 'marketvalue' y 'sales' son fuertemente asimétricas,
...
# variable categórica en vez de numerica), la representación gráfica más adecuada
# es el llamado diagrama de cajas (boxplot). El siguiente código genera un
# diagrama de cajas de la variable 'marketvalue' para un conjunto de 4 países. #
